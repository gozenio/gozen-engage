...
function gzEngageRenderDashboard () {
    ...
    <div id="gzformbody">
        ...
        <div id="formworkspace">
            <div class="flex justify-between" >
                <h3>Workspaces</h3>
                <a href="https://app.engage.gozen.io/workspace" target="_blank" class="CreateWSlink" >
                    <span >
            ...
            <hr/>
            <div id="workspacelist" class="customscroll" >
            </div>
        </div>
        ...
        <div id="formembedlist">
            <div id="formsearch">
                ...
                <div id="gzcreatenewfrom">
                    <a href="<?php echo esc_url(GOZEN_ENGAGE_LOGIN_HOST_URL."/wp-admin/admin.php?page=templates") ?>" >
                        ...
                        <span style="margin:auto;font-size:14px;">Create Campaign<span>
                    </a>
                </div>
            </div>
            <div id="gzlistedforms" class="customscroll">
